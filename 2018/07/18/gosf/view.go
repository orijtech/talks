...
var LatencyView = view.View{
	Measure: MLatency, Name: "demo/latency", Description: "Latency per call", TagKeys: []tag.Key{KeyMethod},
	Aggregation: view.DistributionAggregation(0, 5, 10, 20, 50, 100, 200, 300, 500, 800),
}
